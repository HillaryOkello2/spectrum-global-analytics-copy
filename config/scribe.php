...
return [
    ...
    'title' => 'Spectrum Global Analytics API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'REST API for the Spectrum Global Analytics subscription intelligence platform. All endpoints are namespaced under /api/v1 and return JSON.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token from <code>POST /api/v1/auth/login</code>. Send it as <code>Authorization: Bearer {token}</code>. Subscriber tokens can only reach Subscriber endpoints; Admin tokens reach Admin endpoints.',
    ],
